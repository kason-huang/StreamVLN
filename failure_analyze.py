...
from streamvln.habitat_extensions import measures # 初始化注册

CONFIG_PATH = "config/vln_r2r_envdrop.yaml"  # Path to the Habitat config file
...
for episode in env.episodes:
    ...
    while not env.episode_over:
        ...
        rgb_dir = f"data/trajectory_data/EnvDrop_tmp/{video_id}/rgb"
