...
CONFIG_PATH = "config/vln_r2r_envdrop.yaml"
ANNOT_PATH = "/data/home/jiangjiajun/data/streamvln_datasets/trajectory_data/EnvDrop/annotations.json"
GOAL_RADIUS = 0.25
...
for episode in tqdm(env.episodes, desc="Processing episodes"):
    ...
    rgb_dir = f"/data/home/jiangjiajun/data/streamvln_datasets/trajectory_data/EnvDrop/{video_id}/rgb"
