...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", type=str, default="./data/", help="StreamVLN data root directory")
    parser.add_argument("--repo_name", type=str, default="vln_ce_lerobot", help="Output dataset name")
    parser.add_argument("--output_dir", type=str, default="./lerobot_data", help="Output directory (default: LEROBOT_HOME)")
