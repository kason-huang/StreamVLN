...
#export NCCL_NVLS_BUFFSIZE=33554432
...
#OBJNAV_VIDEO_FOLDER="data/trajectory_data/objectNav_test_v0"
#OBJNAV_VIDEO_FOLDER="data/trajectory_data/objNav_test"
...
torchrun --nnodes=$NNODES --nproc_per_node=$NPROC_PER_NODE \
    --standalone streamvln/streamvln_train.py \
    --deepspeed scripts/zero2.json \
    --model_name_or_path $PREV_STAGE_CHECKPOINT \
    --version $PROMPT_VERSION \
    --objnav_video_folder ${OBJNAV_VIDEO_FOLDER} \
    --group_by_task False \
    \
    --num_history 8 \
    --num_future_steps 4 \
