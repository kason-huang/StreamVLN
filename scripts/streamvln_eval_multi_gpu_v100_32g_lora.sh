...
CHECKPOINT="./checkpoints/StreamVLN_Video_qwen_1_5_1epoch_196token_8history_32frame_lora_20260312/checkpoint-1485"

echo "CHECKPOINT: ${CHECKPOINT}"

time torchrun --nproc_per_node=8 \
    ...
    --output_path "results/vals/unseen/vln/streamvln_lora_epoch_3_1"
